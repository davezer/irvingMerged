...
export const managers = [
  ...
  { // array 4
    ...
    favoriteTeam: "gb",
    mode: "Rebuild",
    rival: { name: "Brian James", link: 10, image: "/managers/Kansas City Kodachromes.png" },
    yearsOfService: "Ten",
    persona: "The Wolf",
