  ...
  <section class="card import-card">
    ...
    {#if data.legacyImport?.rowCount > 0}
      ...
      <div>
        ...
        <p>
          ...
          through
          {data.legacyImport.lastDate}.
          Opening-balance snapshots have been retired.
        </p>
    ...
    {:else}
      ...
      <div>
        ...
        <h2>
          Backfill complete transaction history
        </h2>

        <p>
          Upload the exported Google Sheets
          Ledger CSV. The importer will refuse
          to commit unless all 14 calculated
          balances exactly match the current
          D1 capital board.
        </p>
...
{/if}
  ...
  <section class="section">
    ...
    <div class="trade-stack">
      ...
      {#each data.trades as trade}
        ...
        <article
          class:reviewed={trade.reviewStatus !== 'pending'}
          class="trade-card"
        >
            ...
            <div class="trade-body">
              ...
              {#if trade.reviewStatus === 'pending'}
                ...
                <div class="trade-actions">
                  ...
                  <form
                    method="POST"
                    action="?/postTradeCapital"
                    class="capital-trade-form"
                  >
  ...
  />
      ...
      {#if !data.trades.length}
        <div class="empty">
          No stored Sleeper trades found
          for this season.
        </div>
      {/if}
      ...
      >
        ...
        <label>
          ...
          <select name="entryType">
            <option value="annual_funding">
              Annual Funding
            </option>

            <option value="auction_spend">
              Auction Spend
            </option>

            <option value="keeper_signing">
              Keeper Signing
            </option>

            <option value="keeper_tax">
              Keeper Tax
            </option>

            <option value="cap_penalty">
              Cap Penalty
            </option>
  ...
  <strong
    class:money-positive={entry.amount > 0}
    class:money-negative={entry.amount < 0}
  >
    {money(entry.amount)}
  </strong>
...
<style>
  ...
  .success {
    background: rgba(41,160,90,.16);
    border: 1px solid rgba(41,160,90,.55);
  }

  .error {
    background: rgba(200,45,40,.16);
    border: 1px solid rgba(200,45,40,.55);
  }
